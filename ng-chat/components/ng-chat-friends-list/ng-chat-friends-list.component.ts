...
export class NgChatFriendsListComponent implements OnChanges {
    ...
    get filteredParticipants(): IChatParticipant[]
    {
        if (this.searchInput.length > 0){
            ...
            let searchText = transliterate(this.searchInput.toUpperCase());
            return this.participants.filter(x => transliterate(x.displayName.toUpperCase()).includes(searchText));
        }
